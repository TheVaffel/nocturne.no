...
Nåtildags vil du ofte støte på svar generert av kunstig intelligens (KI) også - f.eks. Googles Gemini som flittig prøver å besvare alt du skriver i søkefeltet. Når man benytter seg av KI, er det uansett alltid lurt å ta svarene med en klype salt, men stort sett vil svarene hjelpe deg på veien til å bli en programmerer.

Merk at de aller fleste programmeringsressurser på nettet er på engelsk, så det vil ofte lønne seg å bruke engelsk søketekst.

Utover dét er det viktigste å ikke miste tålmodigheten. Det kan fort skje at du bruker lang tid på feil som virker helt opplagte i ettertid. Ikke bli nedbrutt dersom det skjer, slike flaue øyeblikk er vanlige, selv for erfarne programmerere. Det viktigste er at man lærer av feilene man gjør på veien.

### Oppsummering

Vi har ikke introdusert mye nye programmeringskonsepter her, bare snakket litt om programmering i praksis. Forhåpentligvis har du allerede noen få knagger å henge denne informasjonen på, men mye av stoffet blir mer relevant når du har lært mer og lager større programmer utover i denne serien.

Håper du er klar for å lære mer programmering! Neste post vil ta for seg løkker, som er et svært nyttig konsept. Det er først når vi utforsker løkker at den virkelige kraften som ligger i programmering begynner å åpenbare seg.
